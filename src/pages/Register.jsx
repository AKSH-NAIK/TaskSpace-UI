...
import { UserPlus, User, Mail, Lock, ShieldAlert, CheckCircle, ArrowRight } from 'lucide-react';
      ...
      <div className="glass" style={styles.card}>
        <div style={styles.header}>
          <div style={styles.logoContainer}>
            <UserPlus size={28} color="#A3E635" />
          </div>
          <h1 style={styles.title}>Create Account</h1>
          <p style={styles.subtitle}>Get started for free today</p>
        </div>
